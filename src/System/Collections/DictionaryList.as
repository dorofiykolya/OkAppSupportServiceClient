package System.Collections
{
	 ...
	 * @author dorofiy.com
	 */
	public class DictionaryList extends Proxy implements IDisposable, IEnumerable
	{
		...
		public function DictionaryList(weakKeys:Boolean = false, strictMode:Boolean = false)
		{
			dictionary = new Dictionary(weakKeys);
			dictionaryValue = new Dictionary(weakKeys);
