     ...
     */
        ...
        {      
			...
			public static function show():void {
				War.alert.addChild(instance);
			}
			public static function hide():void {
				if (War.alert.contains(instance)) War.alert.removeChild(instance);
			}
			
			public static function showHide():void {
				if (War.alert.contains(instance)) {
					War.alert.removeChild(instance);
				}else {
					War.alert.addChild(instance);
				}
			}
			...
			private static var inst:Stats;
			public static function get instance():Stats{
				if(inst == null) inst = new Stats();
				return inst as Stats;
			}
			public static function getInstance():Stats{
                ...
                private function init(e : Event) : void
                {
                        ...
                        graphics.beginFill(_theme.bg,0.5);
